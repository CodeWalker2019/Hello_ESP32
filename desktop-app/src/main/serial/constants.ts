...
/** Magic (3) + roll/pitch as big-endian int16, degrees * 100 fixed-point (4). */
export const TELEMETRY_PACKET_LENGTH = 7

/** Wire values are degrees * 100; divide by this to recover degrees. */
export const TELEMETRY_DEGREE_SCALE = 100
